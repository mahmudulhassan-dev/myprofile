...
import ProfileManager from './admin/profile/ProfileManager';
...
import HeaderManager from './admin/layout/HeaderManager';
import FooterManager from './admin/layout/FooterManager';

// MH Commerce Imports
import MHDashboard from './admin/commerce/MHDashboard';
import CategoryManager from './admin/commerce/CategoryManager';
import AttributeManager from './admin/commerce/AttributeManager';
import StockManager from './admin/commerce/StockManager';
        ...
        <div className="min-h-screen bg-slate-50 font-sans flex">
            ...
            <div className="ml-64 flex-1 flex flex-col min-h-screen">
                ...
                <main className="p-8 flex-1 overflow-y-auto">
                    ...
                    {/* MH Commerce Modules */}
                    {activeTab === 'mh-dashboard' && <MHDashboard />}
                    {activeTab === 'mh-categories' && <CategoryManager />}
                    {activeTab === 'mh-attributes' && <AttributeManager />}
                    {activeTab === 'mh-products' && <ProductManager />}
                    {activeTab === 'mh-stock' && <StockManager />}
